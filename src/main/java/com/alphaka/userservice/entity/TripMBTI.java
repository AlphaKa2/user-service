...
public enum TripMBTI {
    ABLJ("체계적 활동파"), ABLP("즉흥적 모험가"),
    ABSJ("절약형 계획가"), ABSP("즉흥적 절약파"),
    ACLJ("여유로운 탐험가"), ACLP("자유로운 탐닉가"),
    ACSJ("절약형 휴양파"), ACSP("즉흥적 절약 여행가"),
